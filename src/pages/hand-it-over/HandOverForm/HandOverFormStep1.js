        ...
        <>
            ...
            <form>
                <label>
                    ...
                    <input type="radio" name="step1" id="step1choice1" onChange={chooseType} value="ubrania, które nadają się do ponownego użycia"></input>
                ...
                <label>
                    ...
                    <input type="radio" name="step1" id="step1choice2" onChange={chooseType} value="ubrania, do wyrzucenia"></input>
                    <span className={type === "ubrania, do wyrzucenia" ? "checkmark checkmark-selected" : "checkmark"}></span>
                </label>
                <br />
                <label>
                    <h4>zabawki</h4>
                    <input type="radio" name="step1" id="step1choice3" onChange={chooseType} value="zabawki"></input>
                    <span className={type === "zabawki" ? "checkmark checkmark-selected" : "checkmark"}></span>
                </label>
                <br />
                <label>
                    <h4>książki</h4>
                    <input type="radio" name="step1" id="step1choice4" onChange={chooseType} value="książki"></input>
                    <span className={type === "książki" ? "checkmark checkmark-selected" : "checkmark"}></span>
                </label>
                <br />
                <label>
                    <h4>inne</h4>
                    <input type="radio" name="step1" id="step1choice5" onChange={chooseType} value="inne"></input>
